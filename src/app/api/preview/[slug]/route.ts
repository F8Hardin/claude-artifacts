...
function processJSX(source: string): { code: string; componentName: string } {
  ...
  // Replace React named imports with destructuring from global React
  code = code.replace(
  ...
  // Capture and strip "export default Name" as a standalone statement
  code = code.replace(
  ...
  // Remove any remaining import statements (e.g. recharts, lodash)
